...
struct SCRIPT_EVENT_BAN_FROM_CEO : public SCRIPT_EVENT
{
	REGISTER_SCRIPT_EVENT(SCRIPT_EVENT_BAN_FROM_CEO, CeoBan);

	SCR_INT Ban;
};
static_assert(sizeof(SCRIPT_EVENT_BAN_FROM_CEO) == 4 * 8);
